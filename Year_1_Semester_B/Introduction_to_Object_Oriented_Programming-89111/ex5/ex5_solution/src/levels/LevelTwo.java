...
public class LevelTwo implements LevelInformation {
    ...
    public List<Velocity> initialBallVelocities() {
        ...
        ballVelocities.add(Velocity.fromAngleAndSpeed(40, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(50, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(60, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(70, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(80, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(100, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(110, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(120, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(130, 7));
        ballVelocities.add(Velocity.fromAngleAndSpeed(140, 7));
