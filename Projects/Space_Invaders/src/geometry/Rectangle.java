...
public class Rectangle {
     ...
     */
    public void moveRectangleX(double x) {
    ...
    /**
     * Move the Rectangle y pixel's to up ro down.
     * @param y - the number of pixel's we want to move the Rectangle
     */
    public void moveRectangleY(double y) {
        //Move each point the y pixel's
        this.upperLeft.setY(this.upperLeft.getY() + y);
        this.upperRight.setY(this.upperRight.getY() + y);
        this.bottomLeft.setY(this.bottomLeft.getY() + y);
        this.bottomRight.setY(this.bottomRight.getY() + y);
    }
}
